...
export default class Logo {
    constructor() {
        ...
        TextToSVG.load('/themes/custom/cevi/assets/fonts/montserrat/Montserrat-ExtraBold.ttf', (err, textToSvg) => {
    ...
    /**
     * Generate the claim for the website.
     */
    generateClaim() {
        const svg = this.buildClaim();
        this.$claim.html(svg);
        this.$claim.addClass('-start');
    }
    ...
    init() {
        ...
        if (this.claimData && this.$claim.length > 0) {
            this.prepareClaim();
            this.generateClaim();
        }
